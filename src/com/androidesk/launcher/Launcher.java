...
package com.androidesk.launcher;
...
import com.androidesk.launcher.R;
...
//HanJinglu, for wallpaper setting area error in T34 case(isPortrait=false)--------->
//        final int width = isPortrait ? display.getWidth() : display.getHeight();
//        final int height = isPortrait ? display.getHeight() : display.getWidth();
        final int width = isPortrait ? display.getWidth() : display.getWidth();
        final int height = isPortrait ? display.getHeight() : display.getHeight();
//<---------
...
//        }
    ...
    private void openFolder(FolderInfo folderInfo) {
        ...
        if (folderInfo instanceof UserFolderInfo) {
            ...
            openFolder = com.androidesk.launcher.LiveFolder.fromXml(this, folderInfo);
        } else {
            return;
        }
